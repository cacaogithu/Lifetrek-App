...
// Heading Variations
// Variation 1 - Gradient Text (no underline)
...
// Variation 2 - Blue Text with Gradient Line underneath
  ...
  // Slide 7 - Equipamentos de Manufatura
  {
    ...
    content: <div data-slide className="h-full min-h-[800px] max-h-[800px] w-full bg-background">
          <div className="max-w-7xl mx-auto px-16 py-10 h-full flex flex-col justify-center">
            ...
            desc: "Tornos Swiss-type 7 eixos"
          }, {
            img: citizenM32,
          ...
          }].map((item, i) => <GlassCard key={i} className="p-2 group hover:scale-[1.01] transition-transform duration-500 flex gap-3 items-center">
    ...
    content: <div data-slide className="h-full min-h-[800px] max-h-[800px] w-full bg-background">
          <div className="max-w-7xl mx-auto px-16 py-16 h-full flex flex-col justify-center">
            ...
            <div className="mt-8 grid grid-cols-4 gap-6">
              {[citizenL20, citizenM32, doosanNew, robodrill].map((img, i) => <div key={i} className="bg-card/30 rounded-xl p-4 border border-border/20 hover:border-primary/20 transition-colors duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <GlassCard className="p-10 border-l-4 border-accent/30">
                ...
                <ul className="space-y-4">
                  {["Classificação ISO 7 (Classe 10.000)", "Controle de temperatura e umidade", "Pressão positiva constante", "Monitoramento de partículas 24/7"].map((item, i) => <li key={i} className="flex items-center gap-3 text-lg text-muted-foreground">
                      <Check className="text-accent w-5 h-5 flex-shrink-0" strokeWidth={1.5} />
                      <span>{item}</span>
                    </li>)}
                </ul>
              ...
              <GlassCard className="p-10 border-l-4 border-primary/30">
                ...
                <ul className="space-y-4">
                  {["Embalagem primária e secundária", "Selagem de blisters e pouches", "Rotulagem e serialização", "Prontos para esterilização EtO ou Gamma"].map((item, i) => <li key={i} className="flex items-center gap-3 text-lg text-muted-foreground">
