...
const PitchDeck = () => {
          ...
          <div className="relative max-w-7xl mx-auto px-16 py-16 h-full flex flex-col justify-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
              <div className="space-y-6">
                {[{
              title: "OEMs de Implantes Ortopédicos",
              desc: "Trauma, coluna, extremidades superiores e inferiores"
            }, {
              title: "Fabricantes de Dispositivos Dentais",
              desc: "Implantes, instrumentos e componentes protéticos"
            }, {
              title: "Empresas de Implantes Veterinários",
              desc: "Dispositivos ortopédicos para animais de grande e pequeno porte"
            }].map((item, i) => <div key={i} className="flex items-start gap-4 group relative">
              ...
              <div className="space-y-6">
                {[{
              title: "Hospitais e Sistemas de Saúde",
              desc: "Instrumentos cirúrgicos customizados e ferramentas específicas"
            }, {
              title: "Parceiros OEM / Contract Manufacturing",
              desc: "Empresas que precisam de capacidade de manufatura certificada ISO 13485"
            }].map((item, i) => <div key={i} className="flex items-start gap-4 group relative">
  ...
  // Slide 3 - O Problema
  {
    ...
    content: <div data-slide className="h-full min-h-[800px] max-h-[800px] w-full bg-gradient-to-br from-secondary/30 via-background to-background relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-16 py-16 h-full flex flex-col justify-center">
            ...
            desc: "Tolerâncias que \"variam\" entre lotes, causando recalls e custos ocultos de retrabalho.",
            gradient: "from-destructive/5 via-transparent to-transparent",
            borderColor: "border-destructive/20"
          }, {
            Icon: FileX,
            title: "Documentação Fraca",
            desc: "Falta de rastreabilidade lote-a-lote e registros auditáveis para reguladores.",
            gradient: "from-accent-orange/5 via-transparent to-transparent",
            borderColor: "border-accent-orange/20"
          }, {
            Icon: Clock,
            title: "Atrasos em Lançamentos",
            desc: "Lead times imprevisíveis que atrasam estudos clínicos e aprovações de mercado.",
            gradient: "from-primary/5 via-transparent to-transparent",
            borderColor: "border-primary/20"
          }, {
            Icon: Shield,
            title: "Riscos de Contaminação",
            desc: "Oficinas sem ambiente controlado que comprometem a esterilidade do produto final.",
            gradient: "from-accent/5 via-transparent to-transparent",
            borderColor: "border-accent/20"
          }, {
            Icon: FileX,
            title: "Fornecedores sem ISO 13485",
            desc: "Parceiros que não entendem requisitos médicos e não têm sistemas de qualidade certificados.",
            gradient: "from-destructive/5 via-transparent to-transparent",
            borderColor: "border-destructive/20"
          }, {
            Icon: AlertTriangle,
            title: "Um Lote Ruim = Dano Permanente",
            desc: "Reputação destruída, confiança de médicos perdida e processos legais custosos.",
            gradient: "from-accent-orange/5 via-transparent to-transparent",
            borderColor: "border-accent-orange/20"
          }].map((item, i) => <div key={i} className={`bg-card/50 backdrop-blur-sm border ${item.borderColor} rounded-2xl p-8 hover:border-primary/30 hover:shadow-[0_8px_24px_-4px_rgba(0,0,0,0.1)] transition-all duration-500 relative overflow-hidden group`}>
    ...
    content: <div data-slide className="relative h-full min-h-[800px] max-h-[800px] w-full bg-background overflow-hidden">
        ...
        backgroundImage: `url(${labOverview})`
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-16 py-16 h-full flex flex-col justify-center">
            ...
            title: "Foco Exclusivo Médico",
            desc: "30+ anos exclusivamente em implantes e instrumentos cirúrgicos. Não fazemos automotive, aerospace ou consumer. Apenas medical."
          }, {
            Icon: CheckCircle,
            color: "text-accent",
            accent: "accent",
            title: "QMS Certificado",
            desc: "ISO 13485:2016 completo, com auditorias anuais. Sistemas de qualidade que funcionam de verdade, não apenas documentos na gaveta."
          }, {
            Icon: Microscope,
            color: "text-primary",
            accent: "accent-orange",
            title: "Mentalidade Zero-Defeito",
            desc: "CMM ZEISS 3D, inspeção óptica automatizada, análise de dureza e rugosidade. Medimos tudo, documentamos tudo."
          }, {
            Icon: Shield,
            color: "text-accent",
            accent: "accent",
  ...
  // Slide 5 - O Que Fazemos
  {
    ...
    content: <div data-slide className="h-full min-h-[800px] max-h-[800px] w-full bg-background">
          <div className="max-w-7xl mx-auto px-16 py-16 h-full flex flex-col justify-center">
            ...
            desc: "Placas e parafusos de trauma, sistemas de fusão espinhal, implantes de membros superiores/inferiores, fixação craniana.",
            gradient: "from-primary/10 via-primary/5 to-transparent",
            border: "border-primary/20"
          }, {
            bg: surgicalDrills,
            title: "Instrumentos Cirúrgicos",
            desc: "Brocas, fresas, alargadores, guides de perfuração, instrumentais para cirurgias complexas e ferramentas customizadas.",
            gradient: "from-accent/10 via-accent/5 to-transparent",
            border: "border-accent/20"
          }, {
            bg: dentalInstruments,
            title: "Dispositivos Dentais",
            desc: "Implantes dentários, pilares protéticos (angulados e retos), componentes para sistemas de fixação e instrumentos específicos.",
            gradient: "from-primary/10 via-accent/5 to-transparent",
            border: "border-primary/20"
          }, {
            bg: veterinaryImplant1,
            title: "Implantes Veterinários",
            desc: "Dispositivos ortopédicos para animais de grande e pequeno porte, placas, parafusos e sistemas de fixação veterinários.",
    ...
    content: <div className="h-full min-h-[800px] max-h-[800px] w-full bg-background">
          <div className="max-w-7xl mx-auto px-16 py-16 h-full flex flex-col justify-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <GlassCard className="p-10 relative overflow-hidden border-l-4 border-primary/20">
                ...
                <ul className="relative space-y-4">
                  {["Citizen Cincom L20 (7 eixos)", "Citizen Cincom L32 (diâmetros até 32mm)", "Citizen Cincom M32 (alta precisão)", "Tornos GT26 e GT13"].map((item, i) => <li key={i} className="flex items-center gap-3 text-lg text-muted-foreground border-l-2 border-accent-orange/10 pl-3">
              ...
              <GlassCard className="p-10 relative overflow-hidden border-l-4 border-accent/20">
                ...
                <ul className="relative space-y-4">
                  {["Doosan DNM 400 (5 eixos)", "FANUC Robodrill (alta velocidade)", "Retíficas Walter", "Laser Marking fibra"].map((item, i) => <li key={i} className="flex items-center gap-3 text-lg text-muted-foreground border-l-2 border-accent-orange/10 pl-3">
                      <Check className="text-accent w-5 h-5 flex-shrink-0" strokeWidth={1.5} />
                      <span>{item}</span>
                    </li>)}
                </ul>
            ...
            <div className="mt-8 grid grid-cols-4 gap-6">
              {[citizenL20, citizenM32, doosanNew, robodrill].map((img, i) => <div key={i} className="bg-card/30 rounded-xl p-4 border border-border/20 hover:border-primary/20 transition-colors duration-500 relative overflow-hidden group">
  ...
  // Slide 7C - Infraestrutura: Cleanrooms
  {
    id: 10,
    content: <div className="h-full min-h-[800px] max-h-[800px] w-full bg-background relative overflow-hidden">
          <div className="absolute inset-0 bg-cover bg-center opacity-[0.06]" style={{
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                <GlassCard className="p-10 relative overflow-hidden mb-8 border-l-4 border-accent/20">
                  ...
                  <ul className="relative space-y-4">
                    {["Monitoramento contínuo de partículas", "Temperatura e umidade controladas", "Pressão positiva diferencial", "Acesso controlado com paramentação"].map((item, i) => <li key={i} className="flex items-start gap-3 border-l-2 border-accent-orange/10 pl-3">
  ...
  // Slide 8 - Clientes
  {
    ...
    content: <div className="relative h-full min-h-[800px] max-h-[800px] w-full bg-background overflow-hidden">
          <div className="absolute inset-0 bg-cover bg-center opacity-[0.05]" style={{
        backgroundImage: `url(${factoryExterior})`
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-16 py-16 h-full flex flex-col justify-center">
            ...
            <div className="grid grid-cols-3 gap-6">
              {[{
            num: "30+",
            label: "Clientes Médicos Ativos",
            gradient: "from-primary via-primary to-primary-dark",
            borderTop: "from-primary/30 via-primary/50 to-primary/30"
          }, {
            num: "30+",
            label: "Anos de Experiência",
            gradient: "from-accent via-accent to-accent/80",
            borderTop: "from-accent/30 via-accent/50 to-accent/30"
          }, {
            num: "100%",
            label: "Produtos com Qualidade Assegurada",
            gradient: "from-accent-orange via-accent-orange to-accent-orange/80",
            borderTop: "from-accent-orange/30 via-accent-orange/50 to-accent-orange/30"
          }].map((item, i) => <GlassCard key={i} className="p-10 text-center relative overflow-hidden group">
    ...
    content: <div className="h-full min-h-[800px] max-h-[800px] w-full bg-background">
          <div className="max-w-7xl mx-auto px-16 py-16 h-full flex flex-col justify-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
              <div className="space-y-6">
                {[{
              title: "1-3 componentes críticos",
              desc: "Escolha as peças mais desafiadoras do seu portfólio"
            }, {
              title: "Processo completo",
              desc: "Usinagem → acabamento → metrologia → embalagem cleanroom"
            }, {
              title: "Documentação completa",
              desc: "Toda documentação para seu arquivo regulatório (DHF/DMR)"
            }].map((item, i) => <div key={i} className="flex items-start gap-4 group">
              ...
              <GlassCard className="p-10 bg-gradient-to-br from-primary/5 to-accent/5 border-2 border-primary/20">
                ...
                <ul className="space-y-3 text-lg text-muted-foreground">
                  {["Toda documentação de processo", "Relatórios completos de medição", "Lições aprendidas e recomendações"].map((item, i) => <li key={i} className="flex items-center gap-3"><CheckCircle className="text-accent w-6 h-6 flex-shrink-0" />{item}</li>)}
                </ul>
              </GlassCard>
            </div>
  ...
  // Slide 10 - Próximos Passos
  {
    ...
    content: <div className="h-full min-h-[800px] max-h-[800px] w-full bg-background">
          <div className="max-w-7xl mx-auto px-16 py-16 h-full flex flex-col justify-center">
            ...
            num: "1",
            title: "Assinar NDA",
            desc: "Confidencialidade garantida para todas as informações técnicas e comerciais",
            border: "border-primary/30"
          }, {
            num: "2",
            title: "Compartilhar Requisitos",
            desc: "Desenhos técnicos, volumes estimados, especificações e certificações necessárias",
            border: "border-primary/30"
          }, {
            num: "3",
            title: "Receber DFM + Cotação",
            desc: "Análise de manufaturabilidade e proposta comercial detalhada em 5-7 dias úteis",
            border: "border-accent/50"
          }, {
            num: "4",
            title: "Aprovar Piloto → Escalar",
            desc: "Validação de processo e transição para produção seriada com qualidade garantida",
            border: "border-gradient-to-b from-primary via-accent to-accent-orange"
          }].map((item, i) => <div key={i} className="flex items-start gap-8 relative">
