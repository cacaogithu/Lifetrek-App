...
export default function Home() {
  ...
  return <div className="min-h-screen">
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-gradient-to-br from-primary via-accent to-primary text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div ref={clientsAnimation.elementRef} className={`text-center mb-12 sm:mb-16 scroll-reveal ${clientsAnimation.isVisible ? 'visible' : ''}`}>
            ...
            <div className="w-24 h-1 bg-white/80 mx-auto mb-4 animate-float"></div>
