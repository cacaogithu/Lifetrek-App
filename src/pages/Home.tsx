              ...
              <CarouselContent>
                <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                  <div className="bg-card rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow h-full">
                    <img src={zeissContura} alt="ZEISS Contura G2 3D Coordinate Measuring Machine for precision metrology" className="w-full h-40 sm:h-48 object-cover" loading="lazy" width="300" height="192" />
                    <div className="p-4">
                ...
                <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                  <div className="bg-card rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow h-full">
                    <img src={opticalCnc} alt="Optical CNC comparator for precision measurement" className="w-full h-40 sm:h-48 object-cover" loading="lazy" width="300" height="192" />
                    <div className="p-4">
                ...
                <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                  <div className="bg-card rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow h-full">
                    <img src={opticalManual} alt="Optical Manual" className="w-full h-48 object-cover" />
                    <div className="p-4">
                ...
                <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                  <div className="bg-card rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow h-full">
                    <img src={hardnessVickers} alt="Hardness Vickers" className="w-full h-48 object-cover" />
                    <div className="p-4">
                ...
                <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                  <div className="bg-card rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow h-full">
                    <img src={olympusMicroscope} alt="Olympus Microscope" className="w-full h-48 object-cover" />
                    <div className="p-4">
                ...
                <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                  <div className="bg-card rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow h-full">
                    <img src={labOverview} alt="Lab Overview" className="w-full h-48 object-cover" />
                    <div className="p-4">
          ...
          <div className="mb-12 max-w-5xl mx-auto px-4">
            ...
            <Carousel className="w-full max-w-full overflow-hidden">
              <CarouselContent>
                <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                  <div className="bg-card rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow h-full">
                    <img src={polimento} alt="Polimento" className="w-full h-48 object-cover" />
                    <div className="p-4">
                ...
                <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                  <div className="bg-card rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow h-full">
                    <img src={cortadora} alt="Cortadora" className="w-full h-48 object-cover" />
                    <div className="p-4">
                ...
                <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                  <div className="bg-card rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow h-full">
                    <img src={embutidora} alt="Embutidora" className="w-full h-48 object-cover" />
                    <div className="p-4">
