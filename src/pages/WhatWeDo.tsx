  ...
  return (
    <div className="min-h-screen">
      ...
      <section ref={servicesAnimation.elementRef} className="py-20 sm:py-32 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-blue-50/30 via-transparent to-transparent dark:from-blue-950/20 dark:via-transparent dark:to-transparent pointer-events-none" style={{ top: '10%', height: '60%' }} />
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
