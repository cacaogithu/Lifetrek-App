...
export const LeadStatusBadge = ({ status }: LeadStatusBadgeProps) => {
  const variants = {
    ...
    in_progress: { label: 'Em Progresso', variant: 'default' as const, className: 'bg-yellow-500 hover:bg-yellow-600 text-foreground' },
    quoted: { label: 'Cotado', variant: 'default' as const, className: 'bg-cyan-500 hover:bg-cyan-600' },
