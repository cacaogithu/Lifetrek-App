...
const translations = {
  en: {
    ...
    "products.veterinary.inProgress": "Solutions in Development",
    "products.veterinary.comingSoon": "Comprehensive veterinary solutions coming soon. Contact us for custom requirements.",
  ...
  pt: {
    ...
    "products.veterinary.inProgress": "Soluções em Desenvolvimento",
    "products.veterinary.comingSoon": "Soluções veterinárias abrangentes em breve. Entre em contato para requisitos personalizados.",
