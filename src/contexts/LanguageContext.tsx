...
const translations = {
  en: {
    ...
    "equipment.name.citizen": "Swiss CNC Technology",
    ...
    "equipment.specs.zeiss.accuracy": "Accuracy: ±0.001mm",
    "equipment.specs.zeiss.range": "Measuring range: 700x1000x600mm",
    "equipment.specs.zeiss.temperature": "Temperature controlled",
    "equipment.specs.citizen.diameter": "Max diameter: 20mm",
    ...
    "equipment.specs.lab.iso": "ISO 17025",
  ...
  pt: {
    ...
    "equipment.name.zeiss": "ZEISS Contura G2",
    "equipment.name.citizen": "Tecnologia CNC Suíça",
    ...
    "equipment.specs.zeiss.accuracy": "Precisão: ±0.001mm",
    "equipment.specs.zeiss.range": "Faixa de medição: 700x1000x600mm",
    "equipment.specs.zeiss.temperature": "Temperatura controlada",
    "equipment.specs.citizen.diameter": "Diâmetro máximo: 20mm",
    ...
    "assessment.hero.subtitle": "Obtenha orientação especializada para seu projeto de dispositivo médico",
