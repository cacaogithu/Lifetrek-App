...
const translations = {
  en: {
    ...
    "timeline.step2.description": "Multi-axis CNC manufacturing with ±0.001mm precision tolerance",
  ...
  pt: {
    ...
    "timeline.step2.description": "Fabricação CNC multi-eixos com tolerância de precisão de ±0,001mm",
